...
unset($fields['privacyProtocolCallbacks']['eval']['multiColumnEditor']['fields']['type']['label'][1], $fields['privacyProtocolCallbacks']['eval']['multiColumnEditor']['fields']['cmsScope']['label'][1]);
